...
<div class="page-container">
    <form action="<%=basePath %>rollplan/save?projectid=${sessionScope.updateproject.projectid}&rollplansendstatus=${sessionScope.rollplan.sendstatus}" method="post" class="form form-horizontal" id="form-project-save" name="form-project-save">
        <div class="row cl">
