...
<div class="page-container">
    <form action="${pageContext.request.contextPath }/scheduling/save?schedulingid=${sessionScope.updatescheduling.schedulingid}" method="post" class="form form-horizontal" id="form-article-add" >
        <div class="row cl">
