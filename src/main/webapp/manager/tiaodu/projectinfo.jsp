...
%>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>调度项目信息<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <form id="myform" name="myform" method="post" action="">
        ...
        <span class="l">
            <input type="button" class="btn btn-primary radius"  value="确定关闭"  onclick="guanbi()"  />
            <input type="button" class="btn btn-primary radius"  value="返回上一步"  onclick="history.go(-1)"  />
        </span>
    ...
    <script type="text/javascript">
        ...
        function guanbi() {
                    window.location.href = "<%=request.getContextPath()%>/scheduling/bianzhi";
        }
    </script>
</body>
</html>