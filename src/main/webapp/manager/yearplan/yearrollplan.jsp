...
<head>
    ...
    <![endif]-->
    <title>从滚动计划库挑选项目</title>
</head>
<body>
<%
    String scheduname=request.getParameter("name");
%>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>从滚动计划库挑选项目<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div >
        <form action="<%=request.getContextPath()%>/rollplan/search" method="post">
            ...
            所属行业：<input type="text" name="site"   style="width:170px" class="input-text">
        ...
        function tiaoxuan() {
                ...
                if ($("input[type='checkbox']:checked").length == 0) {
                    ...
                    if (window.confirm("您确定挑选这" + count + "个项目吗?")) {
                        window.location.href = "<%=request.getContextPath()%>/yearplan/yearcountytiaoxuan?ids=" + result;
                    }
                }
            }
    </script>
