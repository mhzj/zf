...
<div class="page-container">
    <div >
        <form action="<%=request.getContextPath()%>/rollplan/citysearch" method="post">
    ...
    <script type="text/javascript">
        ...
        function insert() {
            window.location.href = "<%=request.getContextPath()%>/rollplan/cityguanli";
        }
        function update() {
            var result = "";
        ...
        function jiasuo() {
            ...
            if ($("input[type='checkbox']:checked").length == 0) {
                ...
                if (window.confirm("加锁后下级报送部门将无法对项目进行修改,您确定加锁这" + count + "个项目?")) {
                    window.location.href = "<%=request.getContextPath()%>/rollplan/cityjiasuo?ids=" + result;
                }
            }
        }
        function  jiesuo() {
            ...
            if ($("input[type='checkbox']:checked").length == 0) {
                ...
                if (window.confirm("解锁后将允许下级报送部门对项目进行修改,您确定解锁这" + count + "个项目?")) {
                    window.location.href = "<%=request.getContextPath()%>/rollplan/cityjiesuo?ids=" + result;
                }
            }
        ...
        function projectsend( ) {
            ...
            if ($("input[type='checkbox']:checked").length == 0) {
                ...
                if (window.confirm("确定推送这" + count + "个项目?")) {
                    window.location.href = "<%=request.getContextPath()%>/rollplan/citysenddaibao?ids=" + result;
                }
            }
        }
        function delmore() {
            ...
            if ($("input[type='checkbox']:checked").length == 0) {
                ...
                if (window.confirm("确定删除这" + count + "个项目?")) {
                    window.location.href = "<%=request.getContextPath()%>/rollplan/citybianzhidelete?ids=" + result;
                }
            }
        }
    </script>
