...
<div class="page-container">
    <form action="<%=basePath %>review/citysave?projectid=${sessionScope.updateproject.projectid}&rinstitution=${sessionScope.review.institution}" method="post" class="form form-horizontal" id="form-project-save" name="form-project-save">
        <div class="row cl">
