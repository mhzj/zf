...
<div class="page-container">
                <form id="send_form" class="form form-horizontal" action="<%=request.getContextPath()%>/yearplan/successwritefundnumber?yearplanid=${sessionScope.yearplan.yearplanid}"  method="post">
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2">填写资金下达文号：</label>
                    </div>
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>资金下达文号</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="" placeholder="" id="" name="fundnumber">
                        </div>
                    </div>
                    <div class="row cl">
