...
<div class="page-container">
                <form id="send_form" class="form form-horizontal" action="<%=request.getContextPath()%>/yearplan/citysuccessbiangeng?yearplanid=${sessionScope.yearplan.yearplanid}"  method="post">
                    <div class="row cl">
