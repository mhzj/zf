...
<div class="page-container">
                <form id="send_form" class="form form-horizontal" action="<%=request.getContextPath()%>/yearplan/citysuccessbaosong?ids=<%=ids%>"  method="post">
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2">推送至报送区：</label>
                    </div>
                    <div class="row cl">
                    ...
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>投资计划年度</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="" placeholder="" id="" name="applyyear">
                        </div>
                    </div>
                    <div class="row cl">
