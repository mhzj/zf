        ...
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
            ...
            <nav class="nav navbar-nav">
                <ul class="cl">
                    ...
                    <li class="navbar-levelone current"><a href="javascript:;"onclick="product_add('添加资讯','product-add.html')">首页</a></li>
        ...
        <dl id="menu-aaaaa">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="${pageContext.request.contextPath }/review/guanli" data-title="审核区" href="javascript:void(0)">审核区</a></li>
                </ul>
            </dd>
        </dl>
    </div>
