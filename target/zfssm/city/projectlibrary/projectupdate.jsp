...
<div class="page-container">
    <form action="<%=basePath %>projectlibrary/citysave?projectid=${sessionScope.updateproject.projectid}&librarytype=${sessionScope.projectsend.librarytype}" method="post" class="form form-horizontal" id="form-project-save" name="form-project-save">
        <div class="row cl">
