        ...
        <div class="mt-20">
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                ...
                <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                    <a class="paginate_button previous disabled" href="<%=request.getContextPath()%>/review/citysearch?pn=1&projectname='<%=projectname%>'&projectype='<%=projectype%>'&site='<%=site%>'">首页</a>

                    <c:if test="${searchreview.hasPreviousPage }">
                    <span><a href="<%=request.getContextPath()%>/review/citysearch?pn=${searchreview.pageNum-1}&projectname='<%=projectname%>'&projectype='<%=projectype%>'&site='<%=site%>'"
                    ...
                    <c:forEach items="${searchreview.navigatepageNums }" var="page_Num">
                        ...
                        <c:if test="${page_Num != searchreview.pageNum }">
                        <span><a href="<%=request.getContextPath()%>/review/citysearch?pn=${ page_Num}&projectname='<%=projectname%>'&projectype='<%=projectype%>'&site='<%=site%>'">${
                                page_Num}</a>
                        </span>
                        </c:if>
                    </c:forEach>
                    ...
                    <a class="paginate_button next disabled"
                       href="<%=request.getContextPath()%>/review/citysearch?pn=${searchreview.pages}&projectname='<%=projectname%>'&projectype='<%=projectype%>'&site='<%=site%>'">末页</a>
                </div>
            </div>
        </div>
    </form>
