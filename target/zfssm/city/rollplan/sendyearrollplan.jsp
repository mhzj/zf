...
<div class="page-container">
                <form id="send_form" class="form form-horizontal" action="<%=request.getContextPath()%>/rollplan/sendyearrollplan?ids=<%=ids%>&receivesite=${sessionScope.loginUser.reviewdepartment}"  method="post">
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2">滚动计划项目报送：</label>
                    </div>
                    <div class="row cl">
