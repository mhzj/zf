...
<div class="page-container">
    <form action="<%=basePath %>rollplan/citysave?projectid=${sessionScope.updateproject.projectid}&rollplansendstatus=${sessionScope.rollplan.sendstatus}" method="post" class="form form-horizontal" id="form-project-save" name="form-project-save">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${sessionScope.updateproject.countryid}" placeholder="" id="" name="countryid">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">项目编码(地方)：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${sessionScope.updateproject.placeid}" placeholder="" id="" name="placeid">
            </div>
        </div>
