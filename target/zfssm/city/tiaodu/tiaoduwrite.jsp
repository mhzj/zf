...
<div class="page-container">
    <form action="${pageContext.request.contextPath }/scheduling/citysavetiaodu?schedulingid=${sessionScope.scheduling.schedulingid}" method="post" class="form form-horizontal" id="form-article-add" onSubmit="return check(this);" >
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="datemin" value="<fmt:formatDate value="${sessionScope.scheduling.reallystart}" pattern="yyyy-MM-dd"/>" name="reallystart" class="input-text Wdate" style="width:180px;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">实际竣工时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'datemin\')}' })" id="datemax" name="reallyend" value="<fmt:formatDate value="${sessionScope.scheduling.reallyend}" pattern="yyyy-MM-dd"/>" class="input-text Wdate" style="width:180px;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>招投标方式：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="zbtype" readonly="readonly" class="select">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" class="input-text" value="${sessionScope.scheduling.buildunit}" placeholder=""  name="buildunit">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" class="input-text" value="${sessionScope.scheduling.snumber}" placeholder=""  name="snumber">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>形象进度：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="imageprogress" class="select" readonly="readonly">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="fundtype" class="select" readonly="readonly">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" name="allfund"  placeholder="" value="${sessionScope.project.allfund}" class="input-text">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">累计下达资金：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" name="xfund"  placeholder="" value="${sessionScope.project.xfund}" class="input-text">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">累计完成投资：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" name="finvestment"  placeholder="" value="${sessionScope.project.finvestment}" class="input-text">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" name="sendfund"  placeholder="" value="${sessionScope.scheduling.sendfund}" class="input-text">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" readonly="readonly" name="finishfund"  placeholder="" value="${sessionScope.scheduling.finishfund}" class="input-text">
            </div>
        </div>
        <div class="row cl">
