...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 信息发布 <span class="c-gray en">&gt;</span> 收件箱 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div >
        <form action="<%=request.getContextPath()%>/rollplan/search" method="post">
            信息主题:<input type="text" name="name" id=""  style="width:170px" class="input-text">
    ...
    <form id="myform" name="myform" method="post" action="">
        ...
        <span class="l">
            ...
            <%--<input type="button" class="btn btn-primary radius" id="button" value=""  onclick="projectsend()"  />--%>
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort dataTable no-footer">
                    ...
                    <%--<c:forEach items="${pageInfo.list}" var="i" varStatus="suoyin1" >--%>
                        ...
                        <%--<tr class="text-c">--%>
                            ...
                            <%--<td>${suoyin1.index+1}<input type="hidden" name="rollplanid${suoyin1.index+1 }" value="${i.rollplanid }"/></td>--%>
                            <%--<td>${i.projectname}</td>--%>
                            <%--<td>${i.sendstatus}</td>--%>
                            <%--<td>${i.investment}</td>--%>
                            <%--<td>${i.fromsite}</td>--%>
