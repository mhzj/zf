...
<div class="page-container">
    <form action="${pageContext.request.contextPath }/advise/insert" method="post" class="form form-horizontal" id="form-article-add" >
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">新增意见：</label>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">联系电话：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="telphone">
            </div>
        </div>
        <div class="row cl">
