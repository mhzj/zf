...
<div class="page-container">
    ...
    <script type="text/javascript">
        ...
        function tiaoxuan() {
            window.location.href = "<%=request.getContextPath()%>/yearplan/yearcountyguanli";
        }
        ...
        function projectsend( ) {
            ...
            if ($("input[type='checkbox']:checked").length == 0) {
                ...
                if (window.confirm("确定推送这" + count + "个项目?")) {
                    window.location.href = "<%=request.getContextPath()%>/yearplan/senddaibao?ids=" + result;
                }
            }
        }
        function delmore() {
            ...
            if ($("input[type='checkbox']:checked").length == 0) {
                ...
                if (window.confirm("确定删除这" + count + "个项目?")) {
                    window.location.href = "<%=request.getContextPath()%>/yearplan/bianzhidelete?ids=" + result;
                }
            }
        }
    </script>
