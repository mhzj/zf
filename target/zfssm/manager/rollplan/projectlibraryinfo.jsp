...
<head>
    ...
    <![endif]-->
    <title>从本级项目库挑选</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 从本级项目库挑选<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <form id="myform" name="myform" method="post" action="">
        ...
        <span class="l">
            <input type="button" class="btn btn-primary radius"  value="确定"  onclick="insert()"  />
    ...
    <script type="text/javascript">
        ...
        function insert() {
            ...
            if ($("input[type='checkbox']:checked").length == 0) {
                ...
                if (window.confirm("您确定挑选这" + count + "个项目吗?")) {
                    window.location.href = "<%=request.getContextPath()%>/rollplan/countytiaoxuan?ids=" + result;
                }
            }
        }
    </script>
