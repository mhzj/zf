...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2" style="display:none">
        <dl id="menu-aaaaa">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/review/waitguanli" data-title="待审核" href="javascript:void(0)">待审核</a></li>
                    <li><a data-href="${pageContext.request.contextPath }/review/finishreview" data-title="已审核" href="javascript:void(0)">已审核</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-system">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath}/projectlibrary/countyguanli" data-title="全部" href="javascript:void(0)">全部</a></li>
                    <li><a data-href="${pageContext.request.contextPath}/projectlibrary/zftz" data-title="政府投资项目库" href="javascript:void(0)">政府投资项目库</a></li>
                    <li><a data-href="${pageContext.request.contextPath}/projectlibrary/zd" data-title="重点项目库" href="javascript:void(0)">重点项目库</a></li>
                    <li><a data-href="${pageContext.request.contextPath}/projectlibrary/ghcb" data-title="规划储备项目库" href="javascript:void(0)">规划储备项目库</a></li>
                    <li><a data-href="${pageContext.request.contextPath}/projectlibrary/cy" data-title="产业项目库" href="javascript:void(0)">产业项目库</a></li>
                </ul>
            </dd>
        </dl>
    </div>
    ...
    <div class="menu_dropdown bk_2" style="display:none">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/rollplan/bianzhiguanli" data-title="编制区" href="javascript:void(0)">编制区</a></li>
                    <li><a data-href="${pageContext.request.contextPath }/rollplan/daibao" data-title="待报区" href="javascript:void(0)">待报区</a></li>
                    <li><a data-href="${pageContext.request.contextPath }/rollplan/yearrollplan" data-title="三年滚动计划" href="javascript:void(0)">三年滚动计划</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/yearplan/bianzhiguanli" data-title="编制区" href="javascript:void(0)">编制区</a></li>
                    <li><a data-href="${pageContext.request.contextPath }/yearplan/baosong" data-title="报送区" href="javascript:void(0)">报送区</a></li>
                    <li><a data-href="${pageContext.request.contextPath }/yearplan/year" data-title="年度投资计划" href="javascript:void(0)">年度投资计划</a></li>
                    <li><a data-href="${pageContext.request.contextPath }/yearplan/countyreceive" data-title="年度计划下达接收" href="javascript:void(0)">年度计划下达接收</a></li>
                </ul>
            </dd>
        </dl>
    </div>
    <div class="menu_dropdown bk_2" style="display:none">
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/scheduling/bianzhi" data-title="调度任务编制" href="javascript:void(0)">调度任务编制</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/scheduling/countyguanli" data-title="我的调度任务" href="javascript:;">我的调度任务</a></li>
                    <li><a data-href="${pageContext.request.contextPath }/scheduling/finishtask" data-title="已完成任务" href="javascript:void(0)">已完成任务</a></li>
                </ul>
            </dd>
        </dl>
    </div>
