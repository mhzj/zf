...
<div class="page-container">
    <div >
        <form action="<%=request.getContextPath()%>/advise/searchadvise" method="post">
        ...
        <div class="mt-20">
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                ...
                <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                    <a class="paginate_button previous disabled" href="<%=request.getContextPath()%>/advise/searchadvise?pn=1&date1='<%=date1%>'&date2='<%=date2%>'">首页</a>

                    <c:if test="${searchadvise.hasPreviousPage }">
                    <span><a href="<%=request.getContextPath()%>/advise/searchadvise?pn=${searchadvise.pageNum-1}&date1='<%=date1%>'&date2='<%=date2%>'"
                    ...
                    <c:forEach items="${searchadvise.navigatepageNums }" var="page_Num">
                        ...
                        <c:if test="${page_Num != searchadvise.pageNum }">
                        <span><a href="<%=request.getContextPath()%>/advise/searchadvise?pn=${ page_Num}&date1='<%=date1%>'&date2='<%=date2%>'">${
                                page_Num}</a>
                        </span>
                        </c:if>
                    </c:forEach>
                    ...
                    <a class="paginate_button next disabled"
                       href="<%=request.getContextPath()%>/advise/searchadvise?pn=${searchadvise.pages}&date1='<%=date1%>'&date2='<%=date2%>'">末页</a>
                </div>
            </div>
        </div>
    </form>
