...
<div class="page-container">
    <form action="<%=basePath %>project/save?projectid=${sessionScope.updateproject.projectid }" method="post" class="form form-horizontal" id="form-project-save" name="form-project-save">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${sessionScope.updateproject.name}" placeholder="" id="" name="name">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button onClick="project_save_submit(${sessionScope.updateproject.projectid });" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交</button>
...
<script type="text/javascript">
    function project_save_submit(projectid) {
        if (window.confirm("你确定要修改项目信息吗？")) {
            window.location.href="<%=request.getContextPath()%>/project/save?projectid="+projectid;
        }
    }
    function give(){
